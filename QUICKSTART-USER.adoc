...
// Replace oblibeniser, Oblibeniser — See README.adoc for details., just run, Oblibeniser started successfully. with actuals
= oblibeniser — Quick Start for Users
:toc:
:toclevels: 2

== What is oblibeniser?

Oblibeniser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./oblibeniser-portable
----
...
[source]
----
Oblibeniser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/oblibeniser/wiki
