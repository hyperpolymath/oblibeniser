...
doctor:
    @echo "Running diagnostics for oblibeniser..."
...
heal:
    @echo "Attempting auto-repair for oblibeniser..."
...
help-me:
    @echo "=== oblibeniser Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/oblibeniser/issues/new"
    @echo ""
