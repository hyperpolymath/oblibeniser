...
//
// oblibeniser CLI — Make operations reversible and auditable in hostile environments via Oblíbený
...
/// oblibeniser — Make operations reversible and auditable in hostile environments via Oblíbený
#[derive(Parser)]
...
#[derive(Subcommand)]
enum Commands {
    /// Initialise a new oblibeniser.toml manifest.
    Init { #[arg(short, long, default_value = ".")] path: String },
    /// Validate a oblibeniser.toml manifest.
    Validate { #[arg(short, long, default_value = "oblibeniser.toml")] manifest: String },
    /// Generate Oblíbený wrapper, Zig FFI bridge, and C headers.
    Generate {
        #[arg(short, long, default_value = "oblibeniser.toml")] manifest: String,
        #[arg(short, long, default_value = "generated/oblibeniser")] output: String,
    },
    /// Build the generated artifacts.
    Build { #[arg(short, long, default_value = "oblibeniser.toml")] manifest: String, #[arg(long)] release: bool },
    /// Run the workload.
    Run {
        #[arg(short, long, default_value = "oblibeniser.toml")] manifest: String,
    ...
    Info { #[arg(short, long, default_value = "oblibeniser.toml")] manifest: String },
}
